export const db = {
    ...
    items: [
            ...
            reviews: [
                {
                    reviewer_name: "Alice",
                    reviewer_rating: 5,
                    comment: "The Mighty Class C Large [MT] provided an exceptional experience for our family road trip. Spacious interiors, well-equipped kitchen, and comfortable beds made our journey memorable. Highly recommended for larger groups looking for a premium RV.",
                },
                {
                    reviewer_name: "Bob",
                    reviewer_rating: 3,
                    comment: "Decent motorhome, but had some issues with functionality. The kitchen facilities were good, but the gas supply seemed insufficient. Overall, a satisfactory experience for our group.",
                },
            ],
        },
        {
            ...
            reviews: [
                {
                    reviewer_name: "Alice",
                    reviewer_rating: 5,
                    comment: "The El Monte Class C Small [C] was the perfect choice for our family of four. Compact yet surprisingly spacious, it provided all the amenities we needed. The kitchen facilities were excellent, and the overall experience was delightful.",
                },
                {
                    reviewer_name: "Bob",
                    reviewer_rating: 3,
                    comment: "A decent motorhome for a small family. The El Monte Class C Small [C] offered convenience, but the bed setup was a bit cramped. Good for short trips but might need more space for an extended journey.",
                },
            ],
        },
        {
            ...
            reviews: [
                {
                    reviewer_name: "Alice",
                    reviewer_rating: 5,
                    comment: "The El Monte Class A Family Sleeper [AF] provided an opulent experience for our family. The fully integrated features, spacious interiors, and top-notch amenities made our journey unforgettable. Highly recommended for those seeking a luxurious RV adventure.",
                },
                {
                    reviewer_name: "Bob",
                    reviewer_rating: 3,
                    comment: "While the El Monte Class A Family Sleeper [AF] offered luxury, we faced some minor issues during our trip. The gas supply seemed insufficient, and a few amenities had issues. Overall, a good experience, but improvements are needed for the price.",
                },
            ],
        },
        {
            ...
            reviews: [
                ...
                },
                {
                    reviewer_name: "Bob",
                    reviewer_rating: 3,
                    comment: "A decent option for solo travel. The Mavericks provided a comfortable stay, but the lack of bathroom facilities was a drawback. Good for short trips where simplicity is preferred.",
                },
            ],
        },
        {
            ...
            reviews: [
                {
                    reviewer_name: "Alice",
                    reviewer_rating: 5,
                    comment: "The HI-Top Camper provided an exceptional experience for our small group. The interior space was surprisingly roomy, and the kitchen facilities were well-equipped. A fantastic choice for a comfortable and enjoyable road trip.",
                },
                {
                    reviewer_name: "Bob",
                    reviewer_rating: 3,
                    comment: "The HI-Top Camper is a decent option for a small group or couple. While the amenities were satisfactory, the lack of a TV might be a drawback for those seeking entertainment. Overall, a comfortable camper for a short journey.",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            rating: 4.4,
            location: "Ukraine, Lviv",
            description: "Explore with ease and style in the Vagabond Cruiser XL, a nimble yet spacious panel truck...",
            form: "panelTruck",
            length: "6.1m",
            width: "2.0m",
            height: "2.9m",
        ...
        },
        {
            ...
            rating: 4.5,
            location: "Ukraine, Kharkiv",
            description: "Travel far and wide with the Nomad Cruiser, a versatile panel truck with modern amenities...",
            form: "panelTruck",
            length: "5.8m",
            width: "2.1m",
            height: "2.7m",
        ...
        },
        {
            ...
            rating: 4.6,
            location: "Ukraine, Kyiv",
            description: "Set out for the horizon in the Horizon Adventurer, a fully equipped panel truck with all the comforts of home...",
            form: "panelTruck",
            length: "6.3m",
            width: "2.2m",
            height: "3.0m",
        ...
        },
        {
            ...
            rating: 4.6,
            location: "Ukraine, Dnipro",
            description: "The Pathfinder Voyager is ideal for those looking to explore new horizons in comfort...",
            form: "fullyIntegrated",
            length: "7.8m",
            width: "2.5m",
            height: "3.7m",
        ...
        },
        {
            ...
            rating: 4.3,
            location: "Ukraine, Kharkiv",
            description: "The Sunset Voyager is perfect for those who want to enjoy a relaxing journey...",
            form: "fullyIntegrated",
            length: "7.1m",
            width: "2.5m",
            height: "3.5m",
        ...
        },
        {
            ...
            rating: 4.5,
            location: "Ukraine, Odesa",
            description: "The Star Trail Camper is designed for adventurers who want to explore in comfort...",
            form: "panelTruck",
            length: "6.2m",
            width: "2.0m",
            height: "2.8m",
